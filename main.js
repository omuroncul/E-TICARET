  ...
  const createBookItemsHtml = () => {
    ...
    bookList.forEach ((book , index) => {
      ...
      <div class="row book-card">
        <div class="col-6">
          <img class="img-fluid shadow" width="268 " height="400" src="${book.imgSource}">
        </div>
        <div class="col-6 d-flex flex-column justify-content-between">
          ...
          <p class="book-description fos gray">
            ...
            <div>
              ...
              ${book.oldPrice ? ` <span class="gray fs-5 fw-bold old-price">${book.oldPrice}TL</span>`
              :""
            }
            </div>
            <button class="btn-purple" onclick="addBookToBasket(${book.id})">ADD BASKET</button>
        </div>
      </div>
    </div>`;
    });
